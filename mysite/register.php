...
<html>
    ...
    <body> 
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <button id="Dark" type="button" class="navbar-toggle mob" onclick="chooseStyle('Style2', 60);
                            return false;" name="theme" value="D" data-target="#Dark">
                        L
                    </button>
                    <button id="Light" type="button" class="navbar-toggle mob"  onclick="chooseStyle('Style1', 60);
                            return false;" name="theme" value="L" data-target="#Light">
                        D
                    </button>
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    ...
                    <ul class="nav navbar-nav navbar-right" >
                        ...
                        <li><input type="submit" onclick="chooseStyle('Style1', 60);
                                return false;"   name="theme" value="D" id="Dark" class="nonmob"></li>
                        <li><input type="submit" onclick="chooseStyle('Style2', 60);
                                return false;" name="theme" value="L" id="Light" class="nonmob"></li>
        ...
        try {
            ...
            $sql = "INSERT INTO `account`(`username`, `password`, `email`) VALUES ('$user','$pass1', '$email');";
        ...
        ?>
        <form id="main" action="index.html" method="post" id="choice">
            <p>Congratulations new account Created. Welcome 
                <?php
                echo $user;
            ...
            <div>
                <form action="index.html" method="post" id="choice">
                    <button id="change" class="Confirm" type="submit" id="choice" name="Change">Done</button>
                </form>
